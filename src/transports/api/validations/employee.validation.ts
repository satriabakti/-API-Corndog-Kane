...
export const createEmployeeSchema = z.object({
  body: z.object({
    ...
    province_id: z.string().transform((val) => parseInt(val)),
    city_id: z.string().transform((val) => parseInt(val)),
    district_id: z.string().transform((val) => parseInt(val)),
    subdistrict_id: z.string().transform((val) => parseInt(val)),
...
export const updateEmployeeSchema = z.object({
  ...
  body: z.object({
    ...
    province_id: z.string().optional().transform((val) => val ? parseInt(val) : undefined),
    city_id: z.string().optional().transform((val) => val ? parseInt(val) : undefined),
    district_id: z.string().optional().transform((val) => val ? parseInt(val) : undefined),
    subdistrict_id: z.string().optional().transform((val) => val ? parseInt(val) : undefined),
